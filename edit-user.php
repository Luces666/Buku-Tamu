    ...
    <div class="card-shadow mb-4">
        ...
        <div class="card-body">
            <form method="post" action="">
                ...
                <div class="form-group row">
                    <label for="user_role" class="col-sm-3 col-form-label">Usr Role</label>
                    <div class="col-sm-8">
                        <select class="form-control" id="user_role" name="user_role"><?= $data['user_role'] ?>
